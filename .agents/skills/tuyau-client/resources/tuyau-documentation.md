...
As mentioned in the [installation](/docs/installation), we used `createTuyau` to create our client instance in our frontend application. This instance will be used to make requests to our API, and it will also provide some helpers to generate URLs, check the current route, etc.
...
## [](#making-requests-using-the-route-name)Making Requests using the route name
...
### [](#unwrapping-the-response)Unwrapping the response
...
## [](#inferring-request-and-response-types)Inferring request and response types
...
### [](#generating-url-from-route-name)Generating URL from route name
...
## [](#checking-the-current-route)Checking the current route
...
## [](#checking-if-a-route-exists)Checking if a route exists
...
## [](#filtering-generated-routes)Filtering generated routes
...
### [](#why-do-i-get-a-modelobject-type-when-returning-a-lucid-model-)Why do I get a `ModelObject` type when returning a Lucid Model ?
...
© 2025 Tuyau [Edit this page](https://github.com/Julien-R44/tuyau/tree/main/docs/content/docs/client.md)
