...
metadata:
  short-description: Writing skills
---

# Documentation

- `.codex/skills` contains all skills
...
- All skills should include frontmatter with name/description/metadata.short-description
  - description should clearly mention _when_ a skill should be used.
  - short-description: only for use in UI, keep it short
