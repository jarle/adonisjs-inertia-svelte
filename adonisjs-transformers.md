...
### [](#understanding-json-serialization)Understanding JSON serialization
...
## [](#creating-your-first-transformer)Creating your first transformer
...
1.  #### Generate the transformer
    ...
    app/transformers/post\_transformer.ts
...
## [](#resource-items-and-collections)Resource items and collections
...
## [](#using-transformers-with-inertia)Using transformers with Inertia
...
### [](#basic-relationship-inclusion)Basic relationship inclusion

First, let's create a transformer for the User model.

app/transformers/user\_transformer.ts
...
### [](#controlling-relationship-depth)Controlling relationship depth
...
### [](#using-variants-in-controllers)Using variants in controllers
...
### [](#variant-types-in-the-frontend)Variant types in the frontend
...
### [](#injecting-httpcontext)Injecting HttpContext
...
## [](#passing-custom-data-to-transformers)Passing custom data to transformers
...
### [](#transformers-are-not-dtos)Transformers are not DTOs
...
### [](#when-to-use-transformers)When to use transformers
...
[Previous](/guides/frontend/inertia)[

Type-safe API Client Learn how to use Tuyau, a type-safe HTTP client for AdonisJS applications that enables end-to-end type safety between backend and frontend.
